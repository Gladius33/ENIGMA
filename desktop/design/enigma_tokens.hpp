...
namespace enigma::design {

inline constexpr auto kPrimary = "#3157FF";
inline constexpr auto kPrimaryDark = "#8EA2FF";
inline constexpr auto kSecondary = "#00B8D9";
inline constexpr auto kEncrypted = "#00C896";
inline constexpr auto kWarning = "#F5A524";
...
inline constexpr int kCornerRadius = 14;
